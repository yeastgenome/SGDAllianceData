...
from ..data_helpers.data_helpers import combine_panther_locus_data, pair_pantherid_to_sgdids, get_output, get_locus_alias_data, get_pers_output
...
# Add name_description if it exists
           ...
           #         obj["name"] = item.name_description
            ...
            if (len(result) > 0):
                ...
                file_name = 'src/data_dump/Persistent_store/SGD' + SUBMISSION_VERSION + 'bgiPersistent.json'
