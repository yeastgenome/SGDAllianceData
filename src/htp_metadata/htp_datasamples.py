...
from ..models.models import DBSession, Dataset, DatasetKeyword, DatasetReference, Referencedbentity, Datasetsample, Dbentity
from ..data_helpers.data_helpers import get_eco_ids, get_output, SUBMISSION_VERSION
...
## make datasetSample metadata file
    ...
    if (len(sampleResult) > 0):
        ...
        file_name = 'src/data_dump/SGD' + SUBMISSION_VERSION + 'htp_samples.json'
